...
namespace FISE_API.Models
{
    public class RegistrationAndLogin
    {
        ...
        {
            Created = new PagedList<StudentModel>();
            Registered = new PagedList<StudentModel>();
            Active = new PagedList<StudentModel>();
        }
        public PagedList<StudentModel> Created { get; set; }
        public PagedList<StudentModel> Registered { get; set; }
        public PagedList<StudentModel> Active { get; set; }
    }
    ...
    {
        public Report2School()
        {
            StudentWise = new Report2StudentWise();
            Section = new List<string>();
        }
    ...
    {
        public Report2StudentWise()
        {
            StudentReport = new List<Report8>();
    ...
    {
        public Report5() {
            BookRead = new List<Report5Data>();
            TimeSpent = new List<Report5Data>();
        }
