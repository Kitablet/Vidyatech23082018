    ...
    var text = {
        ...
        addTitle: function (pie) {
            var title = pie.svg.selectAll("." + pie.cssPrefix + "title")
                ...
                .style("font-family", function (d) { return d.font; }).style("font-weight", "bold");

            pie.svg
           .append("line")
           .attr("id", "TitleSeprator")
           .attr("stroke-width", 1)
           .attr("stroke", "black");
        },
        ...
        positionTitle: function (pie) {
            ...
            if (headerLocation === "pie-center") {
                ...
                if (textComponents.subtitle.exists) {
                    var totalTitleHeight = textComponents.title.h + titleSubtitlePadding + (5 * textComponents.subtitle.h);
        ...
        addSubtitle: function (pie) {
            var headerLocation = pie.options.header.location;
            var TableOfContentsSplit = pie.options.header.subtitle.text.split('/');
            var peid = pie.svg.selectAll("." + pie.cssPrefix + "subtitle");
            $.each(TableOfContentsSplit, function (number) {
                var subt = pie.options.header.subtitle;
                subt.text = TableOfContentsSplit[number];
                peid.data([subt])
                .enter()
                .append("text")
                .text(function (d) { return d.text; })
        ...
        positionSubtitle: function (pie) {
            ...
            var y = text.getHeaderHeight(pie) - 8;
            $("." + pie.cssPrefix + "subtitle").attr("x", x);
            $.each($("." + pie.cssPrefix + "subtitle"), function (number) {
                $(this).attr("y", y + (number * 15));
            });
            //.attr("y", y);
        },
