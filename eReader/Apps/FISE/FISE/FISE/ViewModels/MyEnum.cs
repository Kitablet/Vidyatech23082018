...
{
    public enum UserStatus { Error = 0, Sucess = 1, UserAlreadyRegistered = 2, UserAccountNotExist = 3, WrongCredentails = 4, InvalidToken = 5 }
    public enum SchoolStatus { Error = 0, Sucess = 1, AccountNotFound = 2, AlreadyHaveSchool = 3, NoSchoolFound = 4 }
    ...
    public enum UsernameRecoveryStatus { Error = 0, NoUserexist = 1, Success = 2 }
